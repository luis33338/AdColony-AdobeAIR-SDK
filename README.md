...
==================================
- Modified: 2020/08/21
- Android SDK Version: 4.2.2
- iOS SDK Version: 4.3.0
- Native Extension Version: 4.3.0
...
-----------------------------
* Update AdColony iOS to 4.3.0
* Update AdColony Android to 4.2.2

Change Log (2020/07/28):
-----------------------------
* Update AdColony iOS to 4.2.0
* Update AdColony Android to 4.2.0
...
-----------------------------
* Added support for Android 64-bit architecture.
* Update AdColony iOS to 4.1.0
* Update AdColony Android to 4.1.0
